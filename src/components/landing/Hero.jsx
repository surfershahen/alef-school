...
export default function Hero() {
  ...
  return (
    <SectionContainer className="bg-gradient-to-r from-blue-50 to-white pt-24 pb-8 sm:pt-32 lg:pt-40 lg:pb-14">
      ...
      <div className="flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 z-10 text-center md:text-right">
          <motion.h1
